...
Вы можете указать новые URL (<b>url</b>) и имена (<b>name</b>) индексируемых сайтов. Эти параметры будут отображены на вкладке <b>Dashboard</b> при запуске приложения. 
Для этого необходимо в корневом каталоге проекта найти файл с конфигурациями <b>docker-compose.yml</b> и открыть его в любом текстовом редакторе. Далее заменить адреса и названия на свои. В приложении представлены два сайта: <b>Playback</b> и <b>Svetlovka</b>,
